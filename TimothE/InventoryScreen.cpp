...
void InventoryScreen::Display()
{
	...
	_pInventoryTitle->GetComponent<TextComponent>()->_scale = 2.0f;
	_pInventoryTitle->GetComponent<TextComponent>()->_color = { 0.0f, 0.0f, 0.0f };
	...
	_pInventoryTitle->GetChild()->GetComponent<TextComponent>()->_scale = 1.0f;
	_pInventoryTitle->GetChild()->GetComponent<TextComponent>()->_color = { 0.96f, 0.81f, 0.0f };
	...
	_pInventoryBody->GetComponent<TextComponent>()->_scale = 1.0f;
	_pInventoryBody->GetComponent<TextComponent>()->_color = { 0.0f, 0.0f, 0.0f };
	_pInventoryBody->GetChild()->GetTransform()->SetPosition(450.0f, 950.0f);
	_pInventoryBody->GetChild()->GetComponent<TextComponent>()->_scale = 1.0f;
	_pInventoryBody->GetChild()->GetComponent<TextComponent>()->_color = { 0.0f, 0.0f, 0.0f };
	_pInventoryBody->GetChild()->GetChild()->GetTransform()->SetPosition(1050.0f, 950.0f);
	_pInventoryBody->GetChild()->GetChild()->GetComponent<TextComponent>()->_scale = 1.0f;
	_pInventoryBody->GetChild()->GetChild()->GetComponent<TextComponent>()->_color = { 0.0f, 0.0f, 0.0f };
}
